from .api import PodmanAPIClient
...
class PodmanClient:
    """
    A user client for communicating with the Podman Remote API.

    Example:

        >>> from podman import PodmanClient
        >>> client = PodmanClient(base_url='unix://var/run/docker.sock')

    Args:
        base_url (str): URL to the Podman server. For example,
    ...
    def __init__(self, *args, **kwargs):
        self.api = PodmanAPIClient(*args, **kwargs)
    ...
    close.__doc__ = PodmanAPIClient.close.__doc__
